<template>
  <div class="h-fit bg-red-900 flex flex-col pb-20">
    <h1 class="text-center font-bold text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-amber-500 pt-8">Your review</h1>
    <p class="text-center mx-5 text-white pt-1 sm:text-lg lg:text-xl xl:text-2xl">Your review is also important, leave it below!</p>
    ...
    <div class="flex flex-col mt-10 gap-8">
      ...
      <div class="flex flex-row justify-center text-3xl text-white sm:text-4xl lg:text-5xl xl:text-6xl">
