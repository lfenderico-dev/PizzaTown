<template>
  <div class="bg-black h-fit flex flex-col">
    <h1 class="text-amber-500 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-center pt-10 mb-2 font-bold">Review Section</h1>
    <p class="text-white text-center mx-5 mb-15 sm:text-lg xl:text-2xl">The opinion of others is also important as yours</p>
    <div class="mx-5 h-full flex items-center mb-30">
      <div class="flex flex-col gap-30 items-center">
        ...
        <div>
          <img loading="lazy" class="rounded-full w-[100%] sm:w-[70%] lg:[60%] xl:w-[55%] mx-auto" src="/src/assets/photo/people-portrait/portrait2.jpg">
